...
import com.humaniq.apilib.models.profile.response.DeauthErrorModel;
...
public class ProfileModule extends ReactContextBaseJavaModule {
  ...
  @ReactMethod public void getAddressState(String id, final Promise promise) {
    // MOCK data!
    try {
      WritableMap balanceMock = ModelConverterUtils.convertJsonToMap(
          new JSONObject(" {" + "    \"HMQ\": 190.6," + "    \"USD\": 22.62422" + "  }"));
