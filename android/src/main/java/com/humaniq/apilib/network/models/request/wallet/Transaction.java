...
public class Transaction {
  ...
  @SerializedName("received_transactions") private int receivedTransactions;

  @SerializedName("sent_transactions") private int sentTransactions;

  @SerializedName("invalid_transactions") private int invalidTransactions;
